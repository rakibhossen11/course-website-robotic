                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p className="font-medium">{selectedEnrollment.userEmail}</p>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p className="font-mono text-sm">{selectedEnrollment.userId}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p className="font-medium text-lg">{selectedEnrollment.courseName}</p>
                                        <div className="grid grid-cols-2 gap-4 mt-3">
                                            <div>
                                                <p className="text-sm text-gray-500">Course Price</p>
                                                <p className="font-medium">${selectedEnrollment.coursePrice}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-gray-500">Final Amount</p>
                                                <p className="font-medium">${selectedEnrollment.finalAmount}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <p className="font-mono font-medium">{selectedEnrollment.transactionId}</p>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            <p className="text-sm text-gray-500">Payment Method</p>
                                            <p className="font-medium">{selectedEnrollment.paymentMethod?.toUpperCase()}</p>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
