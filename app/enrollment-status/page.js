...
export default function EnrollmentStatusPage({ searchParams }) {
    ...
    switch (status) {
      ...
      case 'approved':
        return {
          ...
          message:
            'Congratulations! Your enrollment has been approved and you now have full access to the course.',
          instructions: [
      ...
      default:
        return {
          ...
          message: 'We are checking your enrollment status...',
          instructions: [],
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <div className={`rounded-2xl border-2 p-8 ${statusInfo.color}`}>
          <div className="text-center">
            ...
            <div className="space-y-4">
              <Link
                href="/dashboard"
                className="w-full inline-flex justify-center py-3 px-4 rounded-md text-white bg-blue-600 hover:bg-blue-700"
              >
                Go to Dashboard
              </Link>
              ...
              {status === 'pending' && (
                <Link
                  href="/course-details"
                  className="w-full inline-flex justify-center py-3 px-4 rounded-md bg-white border"
                >
                  Browse Courses
                </Link>
              )}
              ...
              {status === 'rejected' && (
                <Link
                  href="/checkout"
                  className="w-full inline-flex justify-center py-3 px-4 rounded-md text-white bg-red-600 hover:bg-red-700"
                >
                  Try Again
                </Link>
              )}
        ...
        <p className="text-center text-sm text-gray-600">
          Need help?{' '}
          <a
            href="mailto:support@learningbd.com"
